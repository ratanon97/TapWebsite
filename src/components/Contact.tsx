...
const links = [
  { label: "LinkedIn", href: "https://www.linkedin.com/in/ratanon-suksumrun", icon: LinkedInIcon },
  { label: "GitHub", href: "https://github.com/ratanon97", icon: GitHubIcon },
  { label: "Email", href: "mailto:ratanon97@hotmail.com", icon: MailIcon },
];
